...
export const EXERCISE_LIBRARY: ExerciseTemplate[] = [
  ...
  { id: "squat-avant", nom: "Squat avant", groupesMusculaires: ["Quadriceps", "Fessiers"], materiel: ["Barre"], sports: ["Musculation"], qualitesPhysiques: ["Force"], icon: "barbell-outline", pattern: "squat" },
  ...
  { id: "souleve-terre-roumain", nom: "Soulevé de terre roumain", groupesMusculaires: ["Ischio-jambiers", "Fessiers"], materiel: ["Barre"], sports: ["Musculation"], qualitesPhysiques: ["Force", "Hypertrophie"], icon: "barbell-outline", pattern: "hinge" },
  { id: "good-morning", nom: "Good morning", groupesMusculaires: ["Ischio-jambiers", "Dos"], materiel: ["Barre"], sports: ["Musculation"], qualitesPhysiques: ["Force"], icon: "barbell-outline", pattern: "hinge" },
  { id: "fentes", nom: "Fentes", groupesMusculaires: ["Quadriceps", "Fessiers"], materiel: ["Haltères"], sports: ["Général"], qualitesPhysiques: ["Force", "Coordination"], icon: "walk-outline", pattern: "lunge" },
  { id: "hip-thrust", nom: "Hip thrust", groupesMusculaires: ["Fessiers"], materiel: ["Barre", "Banc"], sports: ["Musculation"], qualitesPhysiques: ["Force", "Hypertrophie"], icon: "barbell-outline", pattern: "hinge" },
  ...
  { id: "elevations-laterales", nom: "Élévations latérales", groupesMusculaires: ["Épaules"], materiel: ["Haltères"], sports: ["Musculation"], qualitesPhysiques: ["Hypertrophie"], icon: "fitness-outline", pattern: "isolation" },
