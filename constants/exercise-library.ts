...
export const EXERCISE_LIBRARY: ExerciseTemplate[] = [
  ...
  { id: "rotation-tronc-debout-plaque", nom: "Rotation du tronc debout (disque)", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Coordination"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/rotation-tronc-debout-plaque.png?v=${IMAGE_VERSION}` },
  ...
  { id: "step-up-rotation-disque", nom: "Step-up rotation (disque)", groupesMusculaires: ["Quadriceps", "Fessiers", "Abdominaux"], materiel: ["Haltères", "Banc"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Coordination", "Gainage"], icon: "walk-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/step-up-rotation-disque.png?v=${IMAGE_VERSION}`, execution: ["Disque tenu à deux mains devant la poitrine", "Monter sur le banc/step en poussant sur la jambe avant", "En haut, tourner le buste et le disque vers la jambe montée", "Redescendre en contrôle et revenir face avant"] },
