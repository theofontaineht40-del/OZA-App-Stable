...
export const EXERCISE_LIBRARY: ExerciseTemplate[] = [
  ...
  { id: "tirage-vertical-unilateral", nom: "Tirage vertical unilatéral", groupesMusculaires: ["Dos", "Biceps"], materiel: ["Machine"], sports: ["Musculation"], qualitesPhysiques: ["Force", "Hypertrophie"], icon: "fitness-outline", pattern: "pull_vertical", photoUrl: `${IMAGE_BASE}/tirage-vertical-unilateral.png?v=${IMAGE_VERSION}` },
  ...
  { id: "pallof-press", nom: "Pallof press", groupesMusculaires: ["Abdominaux"], materiel: ["Machine"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/pallof-press.png?v=${IMAGE_VERSION}` },
  ...
  { id: "elevation-frontale", nom: "Élévation frontale", groupesMusculaires: ["Épaules"], materiel: ["Haltères"], sports: ["Musculation"], qualitesPhysiques: ["Hypertrophie"], icon: "fitness-outline", pattern: "isolation", photoUrl: `${IMAGE_BASE}/elevation-frontale.png?v=${IMAGE_VERSION}` },
  { id: "crunch-machine", nom: "Crunch machine", groupesMusculaires: ["Abdominaux"], materiel: ["Machine"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Hypertrophie", "Gainage"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/crunch-machine.jpg?v=${IMAGE_VERSION}` },
  { id: "leg-raise-machine", nom: "Relevé de jambes (machine)", groupesMusculaires: ["Abdominaux"], materiel: ["Machine"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Hypertrophie"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/leg-raise-machine.jpg?v=${IMAGE_VERSION}` },
  { id: "rotation-tronc-machine", nom: "Rotation du tronc (machine)", groupesMusculaires: ["Abdominaux"], materiel: ["Machine"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Coordination"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/rotation-tronc-machine.jpg?v=${IMAGE_VERSION}` },
  { id: "flexion-laterale-machine", nom: "Flexion latérale (machine)", groupesMusculaires: ["Abdominaux"], materiel: ["Machine"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Hypertrophie"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/flexion-laterale-machine.jpg?v=${IMAGE_VERSION}` },
  { id: "crunch-leste-plaque", nom: "Crunch lesté (plaque)", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Hypertrophie"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/crunch-leste-plaque.jpg?v=${IMAGE_VERSION}` },
  { id: "releve-jambes-leste", nom: "Relevé de jambes lesté", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Hypertrophie"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/releve-jambes-leste.jpg?v=${IMAGE_VERSION}` },
  { id: "rotation-tronc-debout-plaque", nom: "Rotation du tronc debout (plaque)", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Coordination"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/rotation-tronc-debout-plaque.jpg?v=${IMAGE_VERSION}` },
  { id: "rotation-tronc-debout-plaque-neutre", nom: "Rotation du tronc debout, prise neutre (plaque)", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Coordination"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/rotation-tronc-debout-plaque-neutre.jpg?v=${IMAGE_VERSION}` },
  { id: "flexion-laterale-banc-plaque", nom: "Flexion latérale sur banc (plaque)", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères", "Banc"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/flexion-laterale-banc-plaque.jpg?v=${IMAGE_VERSION}` },
  { id: "rollout-plateau-roulettes", nom: "Rollout (plateau à roulettes)", groupesMusculaires: ["Abdominaux"], materiel: ["Poids du corps"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/rollout-plateau-roulettes.jpg?v=${IMAGE_VERSION}` },
  { id: "rollout-plateau-roulettes-jambe-tendue", nom: "Rollout jambe tendue (plateau à roulettes)", groupesMusculaires: ["Abdominaux"], materiel: ["Poids du corps"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Coordination"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/rollout-plateau-roulettes-jambe-tendue.jpg?v=${IMAGE_VERSION}` },
  { id: "gainage-montee-genou-plateau", nom: "Gainage montée de genou (plateau à roulettes)", groupesMusculaires: ["Abdominaux"], materiel: ["Poids du corps"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Coordination"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/gainage-montee-genou-plateau.jpg?v=${IMAGE_VERSION}` },
  { id: "rollout-pieds-plateau-roulettes", nom: "Rollout pieds sur plateau à roulettes", groupesMusculaires: ["Abdominaux"], materiel: ["Poids du corps"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/rollout-pieds-plateau-roulettes.jpg?v=${IMAGE_VERSION}` },
  { id: "rollout-alterne-plateau-roulettes", nom: "Rollout alterné (plateau à roulettes)", groupesMusculaires: ["Abdominaux"], materiel: ["Poids du corps"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Coordination"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/rollout-alterne-plateau-roulettes.jpg?v=${IMAGE_VERSION}` },
  { id: "roue-abdominale-banc", nom: "Roue abdominale sur banc", groupesMusculaires: ["Abdominaux"], materiel: ["Poids du corps"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Force"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/roue-abdominale-banc.jpg?v=${IMAGE_VERSION}` },
  { id: "releve-bassin-contrepoids", nom: "Relevé de bassin, barre en contrepoids", groupesMusculaires: ["Abdominaux"], materiel: ["Barre", "Banc"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/releve-bassin-contrepoids.jpg?v=${IMAGE_VERSION}` },
  { id: "swing-baseball-rotation", nom: "Swing baseball (rotation explosive)", groupesMusculaires: ["Abdominaux", "Épaules"], materiel: ["Barre"], sports: ["Général", "Athlétisme"], qualitesPhysiques: ["Puissance", "Coordination"], icon: "flash-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/swing-baseball-rotation.jpg?v=${IMAGE_VERSION}` },
  { id: "rotation-laterale-bras-barres", nom: "Rotation latérale des bras, barres (mobilité)", groupesMusculaires: ["Abdominaux", "Épaules"], materiel: ["Barre"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Mobilité"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/rotation-laterale-bras-barres.jpg?v=${IMAGE_VERSION}` },
  { id: "rotation-landmine", nom: "Rotation en landmine (barre déséquilibrée)", groupesMusculaires: ["Abdominaux"], materiel: ["Barre"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Coordination"], icon: "barbell-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/rotation-landmine.jpg?v=${IMAGE_VERSION}` },
  { id: "flexion-laterale-debout-charge", nom: "Flexion latérale debout, charge dans chaque main", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/flexion-laterale-debout-charge.jpg?v=${IMAGE_VERSION}` },
  { id: "flexion-laterale-unilaterale-charge", nom: "Flexion latérale unilatérale (charge)", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Hypertrophie"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/flexion-laterale-unilaterale-charge.jpg?v=${IMAGE_VERSION}` },
  { id: "rotation-tronc-fente-overhead", nom: "Rotation du tronc en fente avec charge (overhead)", groupesMusculaires: ["Abdominaux", "Fessiers"], materiel: ["Barre"], sports: ["Musculation", "Général", "Athlétisme"], qualitesPhysiques: ["Coordination", "Gainage"], icon: "barbell-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/rotation-tronc-fente-overhead.jpg?v=${IMAGE_VERSION}` },
  { id: "rotation-tronc-explosive", nom: "Rotation tronc explosive, gauche à droite", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Athlétisme", "Général"], qualitesPhysiques: ["Puissance", "Coordination"], icon: "flash-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/rotation-tronc-explosive.jpg?v=${IMAGE_VERSION}` },

  { id: "crunch-bras-tendus-halteres", nom: "Crunch, bras tendus avec haltère", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Hypertrophie", "Gainage"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/crunch-bras-tendus-halteres.jpg?v=${IMAGE_VERSION}` },
  { id: "releve-jambes-leste-haltere", nom: "Relevé de jambes lesté (haltère)", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Hypertrophie", "Gainage"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/releve-jambes-leste-haltere.jpg?v=${IMAGE_VERSION}` },
  { id: "toe-touch-leste", nom: "Toe touch lesté", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Hypertrophie", "Gainage"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/toe-touch-leste.jpg?v=${IMAGE_VERSION}` },
  { id: "crunch-haltere-entre-pieds", nom: "Crunch, haltère entre les pieds", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Hypertrophie", "Gainage"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/crunch-haltere-entre-pieds.jpg?v=${IMAGE_VERSION}` },
  { id: "releve-jambes-banc-haltere-pieds", nom: "Relevé de jambes au banc, haltère aux pieds", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères", "Banc"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Hypertrophie", "Gainage"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/releve-jambes-banc-haltere-pieds.jpg?v=${IMAGE_VERSION}` },
  { id: "situp-jambes-surelevees-haltere", nom: "Sit-up jambes surélevées, avec haltère", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Hypertrophie", "Gainage"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/situp-jambes-surelevees-haltere.jpg?v=${IMAGE_VERSION}` },
  { id: "situp-develope-combine", nom: "Sit-up avec développé combiné", groupesMusculaires: ["Abdominaux", "Épaules"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Coordination", "Hypertrophie"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/situp-develope-combine.jpg?v=${IMAGE_VERSION}` },
  { id: "releve-jambes-banc-cuisses-haltere", nom: "Relevé de jambes au banc, haltère entre les cuisses", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères", "Banc"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Hypertrophie", "Gainage"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/releve-jambes-banc-cuisses-haltere.jpg?v=${IMAGE_VERSION}` },
  { id: "crunch-incline-halteres-ballon", nom: "Crunch incliné sur ballon, avec haltères", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Hypertrophie", "Gainage"], icon: "body-outline", pattern: "core", photoUrl: `${IMAGE_BASE}/crunch-incline-halteres-ballon.jpg?v=${IMAGE_VERSION}` },
  { id: "situp-incline-rotation-halteres", nom: "Sit-up incliné avec rotation, haltères", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Coordination", "Gainage"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/situp-incline-rotation-halteres.jpg?v=${IMAGE_VERSION}` },
  { id: "rotation-tronc-assis-halteres", nom: "Rotation du tronc assis, avec haltères", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général", "Athlétisme"], qualitesPhysiques: ["Coordination", "Gainage"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/rotation-tronc-assis-halteres.jpg?v=${IMAGE_VERSION}` },
  { id: "flexion-laterale-halteres-croises", nom: "Flexion latérale, haltères croisés", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Hypertrophie"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/flexion-laterale-halteres-croises.jpg?v=${IMAGE_VERSION}` },
  { id: "flexion-laterale-fente-haltere", nom: "Flexion latérale en fente, avec haltère", groupesMusculaires: ["Abdominaux", "Fessiers"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Coordination", "Gainage"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/flexion-laterale-fente-haltere.jpg?v=${IMAGE_VERSION}` },
  { id: "windmill-haltere", nom: "Windmill avec haltère", groupesMusculaires: ["Abdominaux", "Épaules"], materiel: ["Haltères"], sports: ["Musculation", "Général", "Athlétisme"], qualitesPhysiques: ["Coordination", "Mobilité"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/windmill-haltere.jpg?v=${IMAGE_VERSION}` },

  { id: "rotation-hanche-genou-leve", nom: "Rotation de hanche, genou levé", groupesMusculaires: ["Fessiers"], materiel: ["Poids du corps"], sports: ["Général", "Athlétisme"], qualitesPhysiques: ["Mobilité", "Coordination"], icon: "body-outline", pattern: "isolation", photoUrl: `${IMAGE_BASE}/rotation-hanche-genou-leve.jpg?v=${IMAGE_VERSION}` },
  { id: "rotation-cheville", nom: "Rotation de cheville", groupesMusculaires: ["Mollets"], materiel: ["Poids du corps"], sports: ["Général", "Athlétisme"], qualitesPhysiques: ["Mobilité"], icon: "body-outline", pattern: "isolation", photoUrl: `${IMAGE_BASE}/rotation-cheville.jpg?v=${IMAGE_VERSION}` },
  { id: "montee-pointes-pieds", nom: "Montée sur pointes de pieds (mobilisation cheville)", groupesMusculaires: ["Mollets"], materiel: ["Poids du corps"], sports: ["Général", "Athlétisme"], qualitesPhysiques: ["Mobilité"], icon: "body-outline", pattern: "isolation", photoUrl: `${IMAGE_BASE}/montee-pointes-pieds.jpg?v=${IMAGE_VERSION}` },
  { id: "marche-sur-talons", nom: "Marche sur les talons", groupesMusculaires: ["Mollets"], materiel: ["Poids du corps"], sports: ["Général", "Athlétisme"], qualitesPhysiques: ["Mobilité", "Coordination"], icon: "body-outline", pattern: "locomotion", photoUrl: `${IMAGE_BASE}/marche-sur-talons.jpg?v=${IMAGE_VERSION}` },
];
