...
export const EXERCISE_LIBRARY: ExerciseTemplate[] = [
  ...
  { id: "rotation-tronc-debout-plaque", nom: "Rotation du tronc debout (plaque)", groupesMusculaires: ["Abdominaux"], materiel: ["Haltères"], sports: ["Musculation", "Général"], qualitesPhysiques: ["Gainage", "Coordination"], icon: "body-outline", pattern: "core_rotation", photoUrl: `${IMAGE_BASE}/rotation-tronc-debout-plaque.png?v=${IMAGE_VERSION}` },
